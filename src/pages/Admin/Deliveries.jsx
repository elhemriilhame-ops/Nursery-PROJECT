    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-slate-400 text-sm font-medium italic">Monitor and manage all botanical shipments in real-time.</p>
        </div>
      ...
      <div className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-[0_4px_30px_rgba(0,0,0,0.02)] relative overflow-hidden">
         <div className="flex items-center justify-between mb-8">
            <div>
               ...
               <p className="text-xs text-slate-400 mt-1">Personnel currently logged into the delivery network.</p>
            </div>
               ...
               <div key={i} className="p-6 rounded-3xl border border-slate-100 hover:border-sage/30 hover:shadow-lg hover:shadow-sage/5 transition-all bg-slate-50/50 group">
                  <div className="flex items-start justify-between mb-4">
                     <div className="relative">
                        <div className="w-12 h-12 rounded-2xl bg-slate-200 text-slate-500 font-black flex items-center justify-center group-hover:bg-sage group-hover:text-white transition-colors">
                           {driver.avatar}
                        </div>
                        {driver.online && (
                  ...
                  <div className="space-y-1 mb-4">
                     ...
                     <p className="text-[10px] text-slate-400 font-bold tracking-widest uppercase">{driver.id}</p>
                  </div>
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-black/[0.02] overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-[#FCFCFB] border-b border-slate-50">
              <tr>
                <th className="px-8 py-5 text-[10px] font-black tracking-widest text-slate-400 uppercase">Tracking & Status</th>
                <th className="px-8 py-5 text-[10px] font-black tracking-widest text-slate-400 uppercase">Customer Information</th>
                <th className="px-8 py-5 text-[10px] font-black tracking-widest text-slate-400 uppercase">Destination Address</th>
                <th className="px-8 py-5 text-[10px] font-black tracking-widest text-slate-400 uppercase">Schedule & Items</th>
                <th className="px-8 py-5 text-[10px] font-black tracking-widest text-slate-400 uppercase">Payment</th>
                <th className="px-8 py-5 text-[10px] font-black tracking-widest text-slate-400 uppercase">Options</th>
              </tr>
            </thead>
                ...
                <tr key={del.id} className="hover:bg-slate-50/50 transition-all group">
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-[10px] text-slate-400 font-bold tracking-widest uppercase italic">Loyal Bloom Member</p>
                       </div>
                    </div>
                  </td>
                  <td className="px-8 py-6 max-w-[280px]">
                    <div className="flex items-start gap-3">
                       ...
                       <p className="text-sm text-slate-500 font-medium leading-relaxed">{del.address}</p>
                    </div>
                  </td>
                  <td className="px-8 py-6">
                    <div className="space-y-3">
                       <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold text-slate-800">{del.date} <span className="text-slate-300 font-medium ml-2">|</span> <span className="text-slate-400 ml-2 font-medium">{del.time}</span></span>
                       </div>
                       <div className="flex items-center gap-2">
                          <Package size={14} className="text-slate-400" />
                          <span className="text-[11px] font-medium text-slate-400 italic truncate max-w-[150px]">{del.items}</span>
                       </div>
                    </div>
                  </td>
                  <td className="px-8 py-6">
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-2">
                       <button className="p-2.5 rounded-xl hover:bg-slate-200/50 text-slate-400 hover:text-slate-800 transition-all">
        ...
        <div className="p-8 bg-[#FCFCFB] text-center border-t border-slate-50">
           <button className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300 hover:text-slate-800 transition-all">
